...
public boolean onNavigationItemSelected(MenuItem item) {
        ...
        startActivity(new Intent(FoodActivityOnline.this,ResearchActivityOnline.class));
        } else if (id == R.id.nav_manage) {

        } else if (id == R.id.nav_home) {
            startActivity(new Intent(FoodActivityOnline.this,MainActivityOnline.class));
        } else if (id == R.id.nav_content) {
                startActivity(new Intent(FoodActivityOnline.this,FoodActivityOnline.class));
        } else if (id == R.id.nav_deconnection) {
        startActivity(new Intent(FoodActivityOnline.this,MainActivity.class));
        }
