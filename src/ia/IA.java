...
public class IA {
	...
	// } else if (current_regime.equals("Vegetarien")) {
	...
	public void creerDonneesUserAimeRecette(Repository repo, ValueFactory vf, Model model, String wcd, Recette rec,
		...
		try {
			...
			List<String> recettes_vegetarien = rec.getNamesRecettesByCategory(repo, "vegetarien");
...
//			System.out.println("vote : "+ votes[i]);
	...
	// User user = new User();
	// System.out.println("Recuperation des logins avec leurs profils");
	...
	public void processOffline(Repository repo, String fichier_profils_nettoyes, String fichier_resultat_cluster)
		...
		MachineLearning ml = new MachineLearning();
		User user = new User();
		System.out.println("Recuperation des logins");
		List<String> all_logins = user.getAllLogins(repo);
		System.out.println("Recuperation des profils");
	...
	public List<String> processOnline(Repository repo, String fichier_profils_nettoyes, String fichier_resultat_cluster,
		...
		System.out.println("Recuperation des profils similaires");
		...
		System.out.println(recettes_retournees.size());
		System.out.println("Suppression des recettes non aimees");
